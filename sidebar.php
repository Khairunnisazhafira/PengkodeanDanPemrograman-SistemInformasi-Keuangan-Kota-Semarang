  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Kota Semarang</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#transaksi-desa" aria-expanded="true" aria-controls="transaksi-desa">
          ...
          <span>Transaksi Daerah</span>
        </a>
        <div id="transaksi-desa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Transaksi Daerah</h6>
            <a class="collapse-item" href="kas.php">Keuangan Daerah</a>
            <a class="collapse-item" href="kategori.php">Kategori Daerah</a>
            <a class="collapse-item" href="laporan_keuangan_desa.php">Laporan Keuangan Kota Semarang</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="transaksi-pinjaman" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="laporan_keuangan_pinjaman.php">Laporan Keuangan Kota Semarang</a>
          </div>
        </div>
      </li>
